...
# ═══════════════════════════════════════════════════════════════════════════════
tab1 = ttk.Frame(nb);
nb.add(tab1, text="  RGB → Grayscale  ")
tab1.columnconfigure(0, weight=1);
tab1.columnconfigure(1, weight=1)
tab1.rowconfigure(1, weight=1)

info1 = tk.Label(tab1,
                 text="Converts a colour image to grayscale using the perceptual weighted average:  gray = 0.299·R + 0.587·G + 0.114·B",
...
# ═══════════════════════════════════════════════════════════════════════════════
tab2 = ttk.Frame(nb);
nb.add(tab2, text="  RGB Channel Split  ")
...
p2_orig = make_panel_frame(tab2, col=0);
t2_orig, l2_orig = image_panel(p2_orig)
p2_r = make_panel_frame(tab2, col=1);
t2_r, l2_r = image_panel(p2_r)
p2_g = make_panel_frame(tab2, col=2);
t2_g, l2_g = image_panel(p2_g)
p2_b = make_panel_frame(tab2, col=3);
t2_b, l2_b = image_panel(p2_b)
...
# ═══════════════════════════════════════════════════════════════════════════════
tab3 = ttk.Frame(nb);
nb.add(tab3, text="  Histogram Stretching  ")
...
p3_orig = make_panel_frame(tab3, col=0);
t3_orig, l3_orig = image_panel(p3_orig)
p3_str = make_panel_frame(tab3, col=1);
t3_str, l3_str = image_panel(p3_str)
...
# ═══════════════════════════════════════════════════════════════════════════════
tab4 = ttk.Frame(nb);
nb.add(tab4, text="  Point Operations  ")
...
p4_orig = make_panel_frame(tab4, col=0);
t4_orig, l4_orig = image_panel(p4_orig)
p4_bright = make_panel_frame(tab4, col=1);
t4_bright, l4_bright = image_panel(p4_bright)
p4_dark = make_panel_frame(tab4, col=2);
t4_dark, l4_dark = image_panel(p4_dark)
p4_contrast = make_panel_frame(tab4, col=3);
t4_contrast, l4_contrast = image_panel(p4_contrast)
